...
void main() {
  testWidgets("can add a new currency", (WidgetTester tester) async {
    ...
    var stateContainer =
        tester.firstState(find.byType(StateContainer)) as StateContainerState;
  ...
  testWidgets("shows snackbar if currency is already added",
      (WidgetTester tester) async {
    var initialAppState = mockAppState();
    initialAppState = initialAppState
        .withConversion(initialAppState.conversion.withCurrencies(["USD"]));
