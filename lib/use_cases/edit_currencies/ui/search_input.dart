  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        hintStyle: TextStyle(color: context.themeColors.text30),
        prefixIconColor: widgetStateColor,
        border: OutlineInputBorder(
          borderSide: BorderSide(color: context.themeColors.text30, width: 2.0),
          borderRadius: BorderRadius.circular(Rounding.small),
        ),
        focusedBorder: OutlineInputBorder(
          borderSide: BorderSide(color: context.themeColors.text, width: 2.0),
          borderRadius: BorderRadius.circular(Rounding.small),
        ),
        hintText: 'Search',
