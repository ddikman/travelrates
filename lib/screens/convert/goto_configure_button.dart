...
class GotoConfigureButton extends StatelessWidget {
  ...
  Widget _buildAndroidButton(BuildContext context) {
    return new IconButton(
      icon: Icon(Icons.mode_edit, color: AppTheme.accentColorLight),
      iconSize: 32.0,
    ...
    return Align(
      ...
      child: Padding(
        ...
        child: new GestureDetector(
          ...
          child: Text(_editButtonLabel, style:
          TextStyle(
            fontSize: 20.0,
            color: new Color(0xFFb6cdfb)
          )),
        ),
      ),
    );
  ...
  String get _editButtonLabel => Intl.message('Edit', name: '_editButtonLabel', desc: 'Text for edit button on currency convert screen');
